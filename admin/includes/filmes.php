                    ...
                    <?php while($filmes      = mysql_fetch_assoc($limite)){ ?>
                          <tr>
                            <td align="center">
                              ...
                              <a class="btn btn-danger" href="functionPHP/exlfilm.php?id=<?=$filmes['id']?>"><em class="fa fa-trash"></em></a>
                            </td>
                            <td class="hidden-xs"><?=$filmes['id']?></td>
                            <td><?=$filmes['titulo']?></td>
                            <td class="link"><?=$filmes['link']?></td>
                            <td class="link">
                              <div class="c<?=$filmes['restri']?>">
                                <?=$filmes['restri']?>
                              </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="functionPHP/editfilm.php" method="POST">
            <label for="usr">Nome:</label>
              <input type="text" class="form-control" name="nome" value="<?=$filmes['titulo']?>" id="usr" >
              <label for="usr">IMG:</label>
              <input type="text" class="form-control" name="img" value="<?=$filmes['img']?>" id="usr" >
              <label for="usr">URL:</label>
              <input type="text" class="form-control" name="url" value="<?=$filmes['link']?>" id="usr" >
...
<!-- --><!-- --><!-- --><!-- --><!-- --><!-- --><!-- --><!-- --><!-- --><!-- --><!-- --><!-- --><!-- --><!-- --><!-- --><!-- --><!-- --><!-- -->
              ...
              <div class="panel-footer">
                <div class="row">
                  <div class="col col-xs-4">Total: <?=$cont_film?>
                  </div>
