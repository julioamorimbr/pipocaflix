 ...
 <? } ?>
	...
	<div class="content">
		<div class="header">
			...
			<?php
      $idMembro = mysqli_real_escape_string($con, $_GET['id']);
			$_SESSION['idPagUser'] =  $idMembro;
       $token_cad = $_SESSION['idPagUser'];
          $_SESSION['tokenCad'] = $token_cad;
       $idMRen = $_SESSION['tokenCad'];
         
      if($idMRen){

          $action = $_GET['action'];
          if($action == NULL){
            include_once("functionPHP/formadepagamento.php");
          }
             elseif($action == "boleto"){
            include_once("functionPHP/bolpag.php");
          }
   elseif($action == "card"){
            include_once("functionPHP/cardpag.php");
          }
