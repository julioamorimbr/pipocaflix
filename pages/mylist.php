...
elseif($order == "az"){
  ...
  $busca = "SELECT * FROM `mylist` WHERE login='$loginM' ORDER by " .$by;
...
<div class="container view">
  <div class="orderby">
    <select onchange="javascript:handleSelect(this)">
      <option value="yr" <?php if($order == NULL or $order == "yr"){?> selected="selected"<? }?> >Ordernar Desc</option>
       <option value="az" <?php if($order == "az"){?> selected="selected"<? }?>>Ordernar ASC</option>
        ...
        <div class="col-sm-6 col-xs-6">
            <div class="list mb-2">
                <div class="list-header">
                    <a href=" ?action=<?=$tipo?>&tag=<?=$dados['id_f']?>" class="list-header-image">
                      <img src="<?=$dados['img']?>">
                    </a>
                </div>
                <div class="list-content">
                    <h2><a href="?action=<?=$tipo?>&tag=<?=$dados['id_f']?>" class="text-black"><?=$dados['title']?></a></h2> 
                    <span class="list-meta">
                      <span class="list-meta-item"><i class="fa fa-clock-o"></i> <?=$dados['ano']?></span> 
                      <a href="#" class="list-meta-item"><i class="fa fa-star"></i> <?=$dados['votos']?></a>
                    </span>
                    <p><?=$dados['sinopse']?></p>
                </div>
            </div>
